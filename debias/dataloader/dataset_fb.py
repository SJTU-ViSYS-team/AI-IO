...
class FbSequence(CompiledSequence):
    ...
    def load(self, data_path):
        ...
        gt_q = traj_target[::subsample_factor, 3:7] # xyzw
        gt_p = traj_target[::subsample_factor, :3]
        gyro = gyro_raw[::subsample_factor, :]
        acc = accel_raw[::subsample_factor, :]
...
class FbSequenceDataset(Dataset):
    def __init__(self, root_dir, dataset_name, data_list, args, data_window_config, **kwargs):
    ...
    def __getitem__(self, item):
        ...
        targ = self.targets[seq_id][frame_id]  # dv of the window
