...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--root_dir", type=str, default="datasets", help="Path to data directory"
    )
    parser.add_argument("--dataset", type=str, default="DIDO")
    parser.add_argument("--out_dir", type=str, default="results/DIDO/debias")
    ...
    parser.add_argument(
        "--imu_freq", type=float, default=400.0, help="subsample frequency when loading dataset"
    )
